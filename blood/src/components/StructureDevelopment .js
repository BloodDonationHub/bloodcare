...
const StructureDevelopment = () => {
  ...
  const imageGrid = [
    ...
    },
    {
      ...
      alt: "Volunteer",
      title: "Volunteer",
      description: "Support the portal’s activities by helping at blood donation events, spreading awareness, and assisting donors and recipients. They play a vital role in engaging the community and ensuring events and campaigns run smoothly."
    }
  ];
